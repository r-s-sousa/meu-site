   ...
   <div class="container" id="pagina">
      ...
      <div class="row">
         ...
         <div class="col-md-6 form-group">
            <label>Nome: </label>
            <input class="form-control" type="text" name="nome" value="<?= $obUser->nome; ?>" required>
            <input type="hidden" name="id" value="<?= $obUser->id; ?>" id="id">
         </div>
         <div class="col-md-6 form-group">
            <label>Email: </label>
            <input class="form-control" type="email" id="email" name="email" value="<?= $obUser->email; ?>" required>
